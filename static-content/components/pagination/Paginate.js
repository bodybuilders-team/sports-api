...
async function Paginate(state, props) {
    ...
    return nav(
        ul({class: "pagination justify-content-center"},
            li({class: "page-item"},
                a({class: "page-link", onClick: onLeftmostArrowClick, ["aria-label"]: "First"},
                    span({["aria-hidden"]: "true"}, "«")
                ),
            ),
            li({class: "page-item"},
                a({class: "page-link", onClick: onLeftArrowClick, ["aria-label"]: "Previous"},
                    span({["aria-hidden"]: "true"}, "<")
                ),
            ),
            ...pages.map(pageNum =>
                li({class: "page-item" + (pageNum === page ? " active" : "")},
                    a(
                        {
                            class: "page-link",
                            onClick: (pageNum === page) ? undefined : onRawPageClick,
                            ["aria-label"]: "" + pageNum
                        },
                        "" + pageNum
                    )
            ...
            li({class: "page-item"},
                a({class: "page-link", onClick: onRightArrowClick, ["aria-label"]: "Next"},
                    span({["aria-hidden"]: "true"}, ">"),
                ),
            ),
            li({class: "page-item"},
                a({class: "page-link", onClick: onRightmostArrowClick, ["aria-label"]: "Last"},
                    span({["aria-hidden"]: "true"}, "»"),
                ),
            ),
        )
